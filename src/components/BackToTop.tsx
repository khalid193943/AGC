    ...
    <AnimatePresence>
      {show && (
        <motion.button
          ...
          className="fixed bottom-5 right-5 md:bottom-7 md:right-7 z-[60] w-14 h-14 rounded-full bg-ink text-salt shadow-[0_20px_40px_-15px_rgba(6,25,58,0.6)] flex items-center justify-center group"
        ...
        >
          <svg viewBox="0 0 56 56" className="absolute inset-0 w-full h-full -rotate-90" aria-hidden>
            ...
            <motion.circle cx="28" cy="28" r="26" fill="none" stroke="#E8B04B" strokeWidth="2" strokeLinecap="round" style={{ pathLength: dash }} />
          </svg>
