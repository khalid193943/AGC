...
import { Baby, Star, Heart, Palette, CheckCircle2 } from 'lucide-react';
...
export const Maternelle = () => {
  const { t } = useLanguage();
  const content = t.maternelle;

  const features = [
    { icon: <Star className="text-amber-500" />, ...content.features[0] },
    { icon: <Heart className="text-red-500" />, ...content.features[1] },
    { icon: <Palette className="text-blue-500" />, ...content.features[2] },
  ];
