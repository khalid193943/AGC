...
import { School, Award, Compass, Landmark, CheckCircle2 } from 'lucide-react';
...
export const Lycee = () => {
  const { t } = useLanguage();
  const content = t.lycee;

  const features = [
    { icon: <Compass className="text-blue-500" />, ...content.features[0] },
    { icon: <Award className="text-amber-500" />, ...content.features[1] },
    { icon: <Landmark className="text-red-500" />, ...content.features[2] },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl">
                <img 
                  src="https://storage.googleapis.com/ux-pilot-public-assets-v2/academy/classroom.jpg" 
                  alt="Education"
                  className="w-full h-full object-cover"
                  referrerPolicy="no-referrer"
                />
              </div>
              <div className="absolute -bottom-8 -right-8 bg-amber-400 p-8 rounded-2xl shadow-xl hidden md:block max-w-xs">
