...
const PrivacyPage: React.FC = () => {
  ...
  const icons = [<Database className="w-6 h-6" />, <Lock className="w-6 h-6" />, <Eye className="w-6 h-6" />, <Shield className="w-6 h-6" />];
    ...
    <main className="bg-white text-blue-950 font-sans selection:bg-amber-400 selection:text-blue-950 overflow-x-hidden">
      ...
      <section className="relative h-[50vh] flex items-center overflow-hidden bg-blue-950 text-white">
        <div className="absolute inset-0 z-0">
          <img 
            src={ASSETS.heroBg} 
            alt="Privacy Policy Georges Claude Private Academy" 
            width="1920"
            height="1080"
            fetchPriority="high"
