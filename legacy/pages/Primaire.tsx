...
import { GraduationCap, BookOpen, Globe, Lightbulb, CheckCircle2 } from 'lucide-react';
...
export const Primaire = () => {
  const { t } = useLanguage();
  const content = t.primaire;

  const features = [
    { icon: <Globe className="text-blue-500" />, ...content.features[0] },
    { icon: <Lightbulb className="text-amber-500" />, ...content.features[1] },
    { icon: <CheckCircle2 className="text-emerald-500" />, ...content.features[2] },
  ];
