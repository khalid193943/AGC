...
import { 
  Baby, Sparkles, Music, Palette, 
  Users, Shield, Heart, Clock,
  CheckCircle2, ArrowRight, Globe,
  BookOpen, Camera, Coffee
} from 'lucide-react';
...
const MaternellePage: React.FC = () => {
  const { t, currentLang } = useLanguage();

  const sections = {
    hero: {
      title: t.maternelle.title,
    ...
    vision: {
      title: t.maternelle.visionTitle,
      text: t.maternelle.visionText,
      image: 'https://cdn.prod.website-files.com/682f40cedbb46cd6e15b45cb/6a07981a0fca9d4e7566b4fc_WhatsApp%20Image%202026-05-15%20at%2022.53.55.jpeg'
    },
    pillars: t.maternelle.pillars.map((pillar: any, idx: number) => ({
      ...pillar,
      icon: [
        <Baby className="text-amber-400" size={32} />,
        <Globe className="text-amber-400" size={32} />,
        <Users className="text-amber-400" size={32} />,
        <Heart className="text-amber-400" size={32} />
      ][idx]
    })),
    curriculum: t.maternelle.curriculum,
    dailyLife: t.maternelle.dailyLife
  };

  return (
    <main className="bg-blue-950 text-white">
      <Helmet>
        <title>École Maternelle El Jadida | Georges Claude Private Academy</title>
        <meta name="description" content="Découvrez notre école maternelle à El Jadida. Un environnement bienveillant et stimulant pour l'éveil et l'épanouissement de votre enfant dès le plus jeune âge." />
        <meta property="og:title" content="École Maternelle El Jadida | Georges Claude Private Academy" />
        <meta property="og:description" content="L'éveil et l'excellence dès la maternelle à El Jadida." />
        <meta property="og:image" content={sections.hero.image} />
        <meta property="og:url" content="https://agc.ma/programmes/maternelle" />
        <link rel="canonical" href="https://agc.ma/programmes/maternelle" />
      </Helmet>
      ...
      <section className="relative h-[70vh] md:h-[80vh] flex items-center overflow-hidden bg-blue-950">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="École Maternelle Académie Georges Claude Private Academy El Jadida" 
            width="1920"
            height="1080"
            fetchPriority="high"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-full mb-8">
                ...
                <span className="text-white text-xs font-bold uppercase tracking-[0.3em]">{t.common.cycle1}</span>
              </div>
              <h1 className="text-white mb-8 font-display font-bold text-4xl md:text-6xl lg:text-7xl leading-none">
                {sections.hero.title} <br />
                <span className="text-amber-400">Georges CLAUDE</span>
              </h1>
            ...
            >
              <div className="aspect-square rounded-[4rem] overflow-hidden border-8 border-white/5">
                <img 
                  ...
                  alt="Vision Pédagogique Maternelle Académie Georges Claude Private Academy El Jadida" 
              ...
              <div className="absolute -bottom-10 -right-10 bg-amber-400 p-12 rounded-[3rem] text-blue-950 hidden md:block">
                ...
                <p className="text-sm font-bold uppercase tracking-widest">{t.common.fulfillment}</p>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="order-2 lg:order-1">
              <div className="grid grid-cols-2 gap-4">
                <img src="https://cdn.prod.website-files.com/682f40cedbb46cd6e15b45cb/6a06432a0dfa1d4698ebf812_20260408_104516%20-%20Copie.jpg" width="800" height="400" className="rounded-[2.5rem] aspect-[2/1] object-cover col-span-2" alt="Activités Maternelle 1" referrerPolicy="no-referrer" loading="lazy" />
                <img src="https://cdn.prod.website-files.com/682f40cedbb46cd6e15b45cb/6a06436b8e9647708e2d4b94_WhatsApp%20Image%202026-03-18%20at%2000.54.42%20(2)%20-%20Copie.jpeg" width="400" height="400" className="rounded-3xl aspect-square object-cover" alt="Activités Maternelle 2" referrerPolicy="no-referrer" loading="lazy" />
                <img src="https://cdn.prod.website-files.com/682f40cedbb46cd6e15b45cb/6a0643698b957947262c740e_prescolaire4.jpg" width="400" height="400" className="rounded-3xl aspect-square object-cover" alt="Activités Maternelle 3" referrerPolicy="no-referrer" loading="lazy" />
              </div>
            </div>
              ...
              <div className="space-y-6">
                {sections.dailyLife.map((item: any, idx: number) => (
                  <div key={idx} className="flex items-center space-x-8 p-6 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                    <span className="text-amber-400 font-bold text-xl w-20">{item.time}</span>
                    <div className="w-px h-8 bg-white/10"></div>
                    <span className="text-blue-100/70 text-sm font-bold">{item.activity}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="section-padding bg-blue-900">
        <div className="max-w-[1400px] mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {t.maternelle.spaces.map((space: any, idx: number) => (
              <div key={idx} className="group relative h-96 rounded-[3rem] overflow-hidden">
                <img 
                  src={[
                    'https://cdn.prod.website-files.com/682f40cedbb46cd6e15b45cb/6a0641da8757c5dc7374be96_20260408_102348.jpg',
                    'https://cdn.prod.website-files.com/682f40cedbb46cd6e15b45cb/6a06413ec3ed04098d4bd38b_20260408_103650.jpg',
                    'https://cdn.prod.website-files.com/682f40cedbb46cd6e15b45cb/6a064206ed8364d9e0de4b63_20260408_102032.jpg'
                  ][idx]} 
                ...
                <div className="absolute bottom-8 left-8">
                  <div className="w-10 h-10 bg-amber-400 rounded-xl flex items-center justify-center text-blue-950 mb-4">
                    {[<BookOpen key="0" />, <Heart key="1" />, <Coffee key="2" />][idx]}
                  </div>
                  <h4 className="text-xl font-bold text-white">{space.title}</h4>
                </div>
              </div>
            ))}
          </div>
